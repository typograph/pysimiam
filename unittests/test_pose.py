...
class testPose(unittest.TestCase):
    ...
    def test_str(self):
        ...
        m = re.match(r'\((?P<x>[^,]+),(?P<y>[^\)]+)\) (?P<theta>.*)$',str(p))
    ...
    def test_shifts(self, a, b):
        ...
        self.assertEqual(a >> Pose(1,1,0), Pose(a,x=a.x+1,y=a.y+1))
        self.assertEqual(a >> Pose(0,0,math.pi/2), Pose(-a.y,a.x,a.theta+math.pi/2))
        self.assertEqual(a >> Pose(0,0,math.pi/2) << Pose(0,0,-math.pi/2), Pose(-a.x,-a.y,a.theta+math.pi))
