...
class testStrictParset(unittest.TestCase):
    ...
    def test_attrs(self):
        ...
        # All are supplied
        self.assertEqual(('3','4','6','7','8'),
                         self.parser.parse_string("<a x='3' y='4' t='6' q='7' z='8'/>")['a'][0])
        ...
        self.assertEqual([None,None],
                         self.parser.parse_string("<c x='3'><e/><e/></c>")['c'][0])
        self.assertRaises(XMLFormatError, self.parser.parse_string,
                     """<c x='3'/>""")
        
        # Collected subtags with default
        self.assertEqual([None,None],
                         self.parser.parse_string("<d x='3'><e/><e/></d>")['d'][0])
        self.assertEqual('3',
                         self.parser.parse_string("<d x='3'/>")['d'][0])
    ...
    def test_Suffix(self):
        ...
        self.assertEqual([None,None], self.parser.parse_string("<a><b/><b/></a>")['a_list'][0])
